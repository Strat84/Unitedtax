    ...
    <Container className="my-12">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose max-w-none">
          ...
          <h2 className="text-xl font-semibold mt-8 mb-4">3. Data Security Measures</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl font-semibold mt-8 mb-4">4. Legal Compliance</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold mt-8 mb-4">6. Your Rights & Choices</h2>
          <p className="mb-4">
